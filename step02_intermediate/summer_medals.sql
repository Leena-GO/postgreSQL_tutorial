...
\copy summer_medals(year, city, sport, discipline, athlete, country, gender, event, medal) FROM 'step02_intermediate/data/summer.csv' with DELIMITER ','  CSV HEADER ENCODING 'UTF8';